    ...
    try {
        ...
        const hashes = assets.map(asset => {
            ...
            return crypto_1.default
                .createHash('md5')
                .update((_b = (_a = asset.content) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : asset.destination, 'utf8')
                .digest('hex');
        });
        let info;
        try {
...
function createAssetCodeBlock({ persist, scales, filename, type, hashes, httpServerLocation, height, width, fileSystemLocation, }) {
    return [
